...
import org.eocencle.winger.javassist.bytecode.stackmap.TypeData.ArrayElement;
import org.eocencle.winger.javassist.bytecode.stackmap.TypeData.UninitData;
import org.eocencle.winger.javassist.bytecode.stackmap.TypeData.UninitTypeVar;
...
public abstract class Tracer implements TypeTag {
	...
	protected int doOpcode(int pos, byte[] code) throws BadBytecode {
		try {
			int e = code[pos] & 255;
			return e < 96 ? (e < 54 ? this.doOpcode0_53(pos, code, e) : this.doOpcode54_95(pos, code, e))
					: (e < 148 ? this.doOpcode96_147(pos, code, e) : this.doOpcode148_201(pos, code, e));
		} catch (ArrayIndexOutOfBoundsException arg3) {
			throw new BadBytecode("inconsistent stack height " + arg3.getMessage(), arg3);
		}
	}
	...
	private int doOpcode0_53(int pos, byte[] code, int op) throws BadBytecode {
		...
		case 50:
			...
			stackTypes[s] = ArrayElement.make(data);
			break;
		case 51:
		case 52:
		case 53:
	...
	private int doOpcode54_95(int pos, byte[] code, int op) throws BadBytecode {
		...
		case 82:
			...
			break;
		case 83:
			ArrayElement.aastore(this.stackTypes[this.stackTop - 3], this.stackTypes[this.stackTop - 1],
					this.classPool);
			this.stackTop -= 3;
			break;
		case 84:
		...
		case 91:
			...
			this.doDUP_XX(1, sp);
			arg5 = this.stackTop;
			this.stackTypes[arg5 - sp] = this.stackTypes[arg5];
			this.stackTop = arg5 + 1;
			break;
		case 92:
			this.doDUP_XX(2, 2);
			this.stackTop += 2;
		...
		case 94:
			...
			arg5 = this.stackTop;
			this.stackTypes[arg5 - sp] = this.stackTypes[arg5];
			this.stackTypes[arg5 - sp + 1] = this.stackTypes[arg5 + 1];
			this.stackTop = arg5 + 2;
			break;
		case 95:
			sp = this.stackTop - 1;
	...
	private int doOpcode148_201(int pos, byte[] code, int op) throws BadBytecode {
		...
		case 170:
			--this.stackTop;
			i = (pos & -4) + 8;
			arg7 = ByteArray.read32bit(code, i);
		...
		case 171:
			...
			i = (pos & -4) + 8;
			arg7 = ByteArray.read32bit(code, i);
			this.visitLookupSwitch(pos, code, arg7, i + 4, ByteArray.read32bit(code, i - 4));
			return arg7 * 8 + 12 - (pos & 3);
		case 172:
			--this.stackTop;
	...
	private int doInvokeMethod(int pos, byte[] code, boolean notStatic) throws BadBytecode {
		...
		if (notStatic) {
			...
			if (target instanceof UninitTypeVar && target.isUninit()) {
				this.constructorCalled(target, ((UninitTypeVar) target).offset());
			} else if (target instanceof UninitData) {
				this.constructorCalled(target, ((UninitData) target).offset());
			}
