...
import org.eocencle.winger.javassist.bytecode.AnnotationsAttribute.Walker;
import org.eocencle.winger.javassist.bytecode.annotation.TypeAnnotationsWriter;
...
public class TypeAnnotationsAttribute extends AttributeInfo {
	...
	public AttributeInfo copy(ConstPool newCp, Map classnames) {
		TypeAnnotationsAttribute.Copier copier = new TypeAnnotationsAttribute.Copier(this.info, this.constPool, newCp,
				classnames);
	...
	void renameClass(Map classnames) {
		TypeAnnotationsAttribute.Renamer renamer = new TypeAnnotationsAttribute.Renamer(this.info, this.getConstPool(),
				classnames);
	...
	static class SubCopier extends TypeAnnotationsAttribute.SubWalker {
		...
		void typeParameterBoundTarget(int pos, int targetType, int typeParameterIndex, int boundIndex)
				throws Exception {
	...
	static class TAWalker extends Walker {
