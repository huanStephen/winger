...
import org.eocencle.winger.javassist.bytecode.annotation.AnnotationMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.AnnotationsWriter;
import org.eocencle.winger.javassist.bytecode.annotation.ArrayMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.BooleanMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.ByteMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.CharMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.ClassMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.DoubleMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.EnumMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.FloatMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.IntegerMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.LongMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.MemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.ShortMemberValue;
import org.eocencle.winger.javassist.bytecode.annotation.StringMemberValue;
...
public class AnnotationsAttribute extends AttributeInfo {
	...
	public AttributeInfo copy(ConstPool newCp, Map classnames) {
		AnnotationsAttribute.Copier copier = new AnnotationsAttribute.Copier(this.info, this.constPool, newCp,
				classnames);
	...
	public void addAnnotation(Annotation annotation) {
		...
		for (int newlist = 0; newlist < annotations.length; ++newlist) {
			if (annotations[newlist].getTypeName().equals(type)) {
				annotations[newlist] = annotation;
				this.setAnnotations(annotations);
				return;
			}
		}

		Annotation[] arg4 = new Annotation[annotations.length + 1];
		System.arraycopy(annotations, 0, arg4, 0, annotations.length);
		arg4[annotations.length] = annotation;
		this.setAnnotations(arg4);
	}
	...
	public void setAnnotations(Annotation[] annotations) {
		...
		try {
			int e = annotations.length;
			writer.numAnnotations(e);
			int i = 0;
	...
	void renameClass(Map classnames) {
		AnnotationsAttribute.Renamer renamer = new AnnotationsAttribute.Renamer(this.info, this.getConstPool(),
				classnames);
