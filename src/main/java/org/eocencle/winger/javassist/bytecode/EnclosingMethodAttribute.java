...
public class EnclosingMethodAttribute extends AttributeInfo {
	...
	public AttributeInfo copy(ConstPool newCp, Map classnames) {
		return this.methodIndex() == 0 ? new EnclosingMethodAttribute(newCp, this.className())
				: new EnclosingMethodAttribute(newCp, this.className(), this.methodName(), this.methodDescriptor());
	}
}
