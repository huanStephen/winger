...
public class Descriptor {
	...
	public static String toClassName(String descriptor) {
		...
		if (i + 1 != descriptor.length()) {
			...
			StringBuffer arg5 = new StringBuffer(name);
	...
	public static String of(String classname) {
		return classname.equals("void") ? "V"
				: (classname.equals("int") ? "I"
						: (classname.equals("byte") ? "B"
								: (classname.equals("long") ? "J"
										: (classname.equals("double") ? "D" : (classname.equals("float") ? "F"
												: (classname.equals("char") ? "C"
														: (classname.equals("short") ? "S"
																: (classname.equals("boolean") ? "Z"
																		: "L" + toJvmName(classname) + ";"))))))));
	}
	...
	private static int toCtClass(ClassPool cp, String desc, int i, CtClass[] args, int n) throws NotFoundException {
		...
		if (arrayDim > 0) {
			StringBuffer arg9 = new StringBuffer(name);
