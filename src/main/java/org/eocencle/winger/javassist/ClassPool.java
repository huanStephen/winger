...
public class ClassPool {
	...
	protected CtClass createCtClass(String classname, boolean useCache) {
		...
		if (!classname.endsWith("[]")) {
			...
			return (!useCache || this.getCached(base) == null) && this.find(base) == null ? null
					: new CtArray(classname, this);
		}
	}
	...
	public Class toClass(CtClass ct, ClassLoader loader, ProtectionDomain domain) throws CannotCompileException {
		try {
			...
			throw new CannotCompileException(arg7.getTargetException());
	...
	private static synchronized Object toClass2(Method method, ClassLoader loader, Object[] args) throws Exception {
		...
		Object arg2;
		try {
			arg2 = method.invoke(loader, args);
		} finally {
		...
		try {
			AccessController.doPrivileged(new PrivilegedExceptionAction() {
				public Object run() throws Exception {
					...
					ClassPool.defineClass1 = cl.getDeclaredMethod("defineClass",
							new Class[] { String.class, byte[].class, Integer.TYPE, Integer.TYPE });
					ClassPool.defineClass2 = cl.getDeclaredMethod("defineClass", new Class[] { String.class,
							byte[].class, Integer.TYPE, Integer.TYPE, ProtectionDomain.class });
					ClassPool.definePackage = cl.getDeclaredMethod("definePackage",
							new Class[] { String.class, String.class, String.class, String.class, String.class,
									String.class, String.class, URL.class });
					return null;
				}
			});
		} catch (PrivilegedActionException arg0) {
			throw new RuntimeException("cannot initialize ClassPool", arg0.getException());
		}
