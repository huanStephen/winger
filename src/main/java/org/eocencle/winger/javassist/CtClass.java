...
public abstract class CtClass {
	...
	public static CtClass booleanType = new CtPrimitiveType("boolean", 'Z', "java.lang.Boolean", "booleanValue", "()Z",
			172, 4, 1);
	...
	public void addField(CtField f) throws CannotCompileException {
		this.addField(f, (Initializer) null);
	}
	...
	public void debugWriteFile(String directoryName) {
		try {
			boolean e = this.stopPruning(true);
