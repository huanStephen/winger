...
public abstract class CtMember {
	...
	protected abstract void extendToString(StringBuffer arg0);
	...
	public abstract void setModifiers(int arg0);

	public abstract boolean hasAnnotation(Class arg0);

	public abstract Object getAnnotation(Class arg0) throws ClassNotFoundException;
	...
	public abstract void setGenericSignature(String arg0);

	public abstract byte[] getAttribute(String arg0);

	public abstract void setAttribute(String arg0, byte[] arg1);
	...
	static class Cache extends CtMember {
		...
		void remove(CtMember mem) {
			...
			while (true) {
				CtMember node = ((CtMember) m).next;
				if (((CtMember) m).next == this) {
					break;
				}
