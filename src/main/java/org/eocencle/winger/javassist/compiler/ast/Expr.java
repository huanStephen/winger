...
import org.eocencle.winger.javassist.compiler.TokenId;
...
public class Expr extends ASTList implements TokenId {
	...
	public String getName() {
		...
		return id < 128 ? String.valueOf((char) id)
				: (350 <= id && id <= 371 ? opNames[id - 350] : (id == 323 ? "instanceof" : String.valueOf(id)));
	}
