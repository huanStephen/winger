...
import org.eocencle.winger.javassist.compiler.SymbolTable;
...
public class CtField extends CtMember {
	...
	static class MethodInitializer extends CtField.NewInitializer {
		...
		private String getDescriptor() {
			...
			return this.stringParams == null
					? (this.withConstructorParams ? "(Ljava/lang/Object;[Ljava/lang/Object;)" : "(Ljava/lang/Object;)")
					: (this.withConstructorParams ? "(Ljava/lang/Object;[Ljava/lang/String;[Ljava/lang/Object;)"
	...
	static class NewInitializer extends CtField.Initializer {
		...
		private String getDescriptor() {
			...
			return this.stringParams == null
					? (this.withConstructorParams ? "(Ljava/lang/Object;[Ljava/lang/Object;)V"
							: "(Ljava/lang/Object;)V")
					: (this.withConstructorParams ? "(Ljava/lang/Object;[Ljava/lang/String;[Ljava/lang/Object;)V"
	...
	static class CodeInitializer extends CtField.CodeInitializer0 {
		...
		int getConstantValue(ConstPool cp, CtClass type) {
			try {
				ASTree e = Javac.parseExpr(this.expression, new SymbolTable());
				return this.getConstantValue2(cp, type, e);
			} catch (CompileError arg3) {
				return 0;
			}
		}
	...
	abstract static class CodeInitializer0 extends CtField.Initializer {
		abstract void compileExpr(Javac arg0) throws CompileError;
		...
		int getConstantValue2(ConstPool cp, CtClass type, ASTree tree) {
			if (type.isPrimitive()) {
				if (tree instanceof IntConst) {
					...
					double value1 = ((DoubleConst) tree).get();
					if (type == CtClass.floatType) {
						return cp.addFloatInfo((float) value1);
					}

					if (type == CtClass.doubleType) {
						return cp.addDoubleInfo(value1);
					}
				}
	...
	public abstract static class Initializer {
		...
		abstract int compile(CtClass arg0, String arg1, Bytecode arg2, CtClass[] arg3, Javac arg4)
				throws CannotCompileException;

		abstract int compileIfStatic(CtClass arg0, String arg1, Bytecode arg2, Javac arg3)
				throws CannotCompileException;
