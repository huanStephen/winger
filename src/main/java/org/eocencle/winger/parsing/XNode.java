...
public class XNode {
	...
	private Properties parseAttributes(Node n) throws WingerException {
	...
	private String parseBody(Node node) throws WingerException {
	...
	private String getBodyData(Node child) throws WingerException {
