...
public class XMLConfigBuilder extends BaseBuilder {
	...
	private void apiResponseElement(XNode node) throws Exception {
		if (node != null) {
			String packet = node.getStringAttribute("scan");
			String container = node.getStringAttribute("container");
			if (packet != null) {
				if (container != null) {
					ResponseAnnotationBuilder responseAnnotationBuilder = new ResponseAnnotationBuilder(this.configuration, packet, container);
