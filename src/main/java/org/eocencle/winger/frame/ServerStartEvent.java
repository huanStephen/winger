...
public class ServerStartEvent implements Event {
	...
	public void process(Map<String, Object> params) {
		try {
			...
			startBtnImage.setImage(new Image(Resources.getResourceAsStream("org/eocencle/winger/frame/resource/image/distart.png")));
			
			Button stopButton = (Button) params.get("stopButton");
			stopButton.setDisable(false);
			stopButton.setText("停止");
			ImageView stopBtnImage = (ImageView) params.get("stopBtnImage");
			stopBtnImage.setImage(new Image(Resources.getResourceAsStream("org/eocencle/winger/frame/resource/image/stopable.png")));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
